...
% =======================================================================
% Implied volatility for SPX500 Index - Heston
% =======================================================================
X = 1:7;
...
for t = 1:length(T)
	...
	title(['SPX500 - Maturity ' num2str(T(t)*252) ' giorni'])
...
% =======================================================================
% Implied volatility SPX500 surface model vs market - Heston
% =======================================================================
figure(2)
surf(K,repmat(T, size(K,1),1), MktIV)  % MktIV
hold on
scatter3(K,repmat(T, size(K,1),1), ModelIV, 'ro', 'filled')  % ModelIV
zlim([0.10 0.25])
xlabel('Strike Price')
ylabel('Tempo (anni)')
title('Heston SPX Implied Volatility')


% =======================================================================
% SPX500 implied risk neutral distribution
% =======================================================================
i = complex(0,1); 
